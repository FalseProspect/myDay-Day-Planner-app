...
(function createSelf(){
  ...
  let moduleGrahicSrc = 'resources/Icons/myDayAppLogoV2.png';
  let modalTitle = 'About';
  let modalContentText = "Dox-Stop is a website to look up the private information of a individual inspire by a scene from the Netflix miniseries 'Maniac'."
  let modalSlideNum = '1/4';
  ...
  let titleBar = makeElement('div','titleBar');
    ...
    slideNum.innerText = modalSlideNum;
  ...
  let modalGraphic = makeElement('div','modal-Graphic');
    ...
    modalGraphicImg.setAttribute('src', moduleGrahicSrc);
  ...
  let modalContent = makeElement('div', 'modal-Content');
    let modalContentInnerText = makeElement('p');
      modalContentInnerText.innerHTML = modalContentText;
